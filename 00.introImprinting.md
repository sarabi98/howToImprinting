...
The counts of the parental alleles are compared between each other per cross and then substracted between both crosses to get the differential expression.
