...
Note: The functions are made with my files as a basis, the function cleanFile must be changed after the comment "right ID and parental labels" to fit the ase-tigar output id and parental descriptions if other files are used!
